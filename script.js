...
function render() {
  ...
  <main dir="${arabic ? "rtl" : "ltr"}">
    ...
    <section class="audience"><div class="shell"><b>${t("REMOTE SUPPORT ACROSS","دعم عن بُعد في")}</b><div>${[["Europe","أوروبا"],["USA","أمريكا"],["UK · Germany · France","بريطانيا · ألمانيا · فرنسا"],["Kuwait · Qatar · UAE","الكويت · قطر · الإمارات"],["Bahrain · Oman · Jordan","البحرين · عُمان · الأردن"]].map(x=>`<span>${t(x[0],x[1])}</span>`).join("")}</div></div></section>
