...
const remoteMarketGroups = [
  ...
  ["Gulf & Middle East","الخليج والشرق الأوسط",[["Saudi Arabia","السعودية"],["United Arab Emirates","الإمارات"],["Qatar","قطر"],["Kuwait","الكويت"],["Bahrain","البحرين"],["Oman","عُمان"],["Jordan","الأردن"],["Egypt","مصر"],["Iraq","العراق"],["Lebanon","لبنان"],["Türkiye","تركيا"]]],
...
function render() {
  ...
  <main dir="${arabic ? "rtl" : "ltr"}">
    ...
    <section id="top" class="hero shell"><div><p class="eyebrow">${t("GLOBAL REMOTE PROJECT SUPPORT · DOCUMENT CONTROL FIRST","دعم مشروعات عالمي عن بُعد · إدارة المستندات أولًا")}</p><h1>${t("Document Control at the center of your project delivery.","إدارة المستندات في قلب تنفيذ مشروعك")}</h1><p class="lead">${t("NASQ provides remote Document Control and Project Support for contractors, consultants, developers and engineering offices across Europe, the United States, the United Kingdom, Germany, France, the Gulf and Jordan. Document Control is our core service, supported by Aconex, SharePoint, Microsoft 365 and practical digital workflows.","تقدم نَسَق خدمات إدارة المستندات ودعم المشروعات عن بُعد للمقاولين والاستشاريين والمطورين والمكاتب الهندسية في أوروبا وأمريكا وإنجلترا وألمانيا وفرنسا ودول الخليج والأردن. إدارة المستندات هي خدمتنا الأساسية بدعم من Aconex وSharePoint وMicrosoft 365 ودورات العمل الرقمية العملية")}</p><div class="actions"><a class="primary" href="#service-lines">${t("Explore services","استكشف الخدمات")}</a><a class="secondary" href="#contact">${t("Request a scope review","اطلب مراجعة نطاق العمل")}</a></div><div class="quick-tools"><a href="tools/document-control-health-check/">${t("Free project assessment","تقييم مجاني للمشروع")} ↗</a><a href="tools/scope-estimator/">${t("Estimate your service scope","حدد نطاق خدمتك")} ↗</a></div><div class="trust"><span>${t("Senior team expertise exceeding 20 years","خبرات قيادية للفريق تتجاوز 20 عامًا")}</span><span>${t("Europe · USA · UK · Gulf · Jordan","أوروبا · أمريكا · بريطانيا · الخليج · الأردن")}</span><span>${t("NDA and controlled access available","اتفاقية سرية وصلاحيات وصول منضبطة")}</span></div></div><aside class="status-card"><p>${t("CHOOSE YOUR SERVICE","اختر خدمتك")}</p><a href="#document-control"><b>01</b><span>Document Control<small>${t("Independent managed service","خدمة مُدارة مستقلة")}</small></span></a><a href="#technical-office"><b>02</b><span>Technical Office<small>${t("Architectural & structural","معماري وإنشائي")}</small></span></a><a href="#integrated"><b>03</b><span>Integrated Package<small>${t("Optional combined delivery","عرض متكامل اختياري")}</small></span></a></aside></section>

    <section class="audience"><div class="shell"><b>${t("REMOTE SUPPORT ACROSS GLOBAL MARKETS","دعم عن بُعد في أسواق متعددة حول العالم")}</b><div>${remoteMarketsMarkup()}</div></div></section>
